...
<script>
import { defineComponent, ref, computed, onMounted, onBeforeUnmount, watch, getCurrentInstance } from 'vue';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const prevSlide = () => {
      currentIndex.value = (currentIndex.value - 1 + slidesLength.value) % slidesLength.value;
    };
